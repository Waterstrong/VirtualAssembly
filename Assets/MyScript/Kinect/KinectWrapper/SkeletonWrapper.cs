...
public class SkeletonWrapper : MonoBehaviour {
    ...
    [HideInInspector]
    public Vector3[] playerPos; //player position // Waterstrong Add
    [HideInInspector]
    public int[] playerState; // player state , edge and so on // Waterstrong Add
    [HideInInspector]
    public bool offsetCalibrated; // offset calibrated // Waterstrong Add
	[HideInInspector]
	...
	void Start () {
        ...
        playerPos = new Vector3[Kinect.Constants.NuiSkeletonMaxTracked]; // Waterstrong Add
        playerState = new int[Kinect.Constants.NuiSkeletonMaxTracked]; // Waterstrong Add
        offsetCalibrated = false; // Waterstrong Add
