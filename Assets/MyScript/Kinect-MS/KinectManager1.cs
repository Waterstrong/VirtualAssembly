...
{
    //FeatureData _featurnData = 
    private MotionSuper _motion = null; // Waterstrong Add

    //AdaptiveUi _adaptiveUi = null;
	...
	public Vector3[] player1JointsPos, player2JointsPos;
	...
	private static KinectManager1 instance;
	
	
    public static KinectManager1 Instance
    {
        get
        {
            return instance;
